...
public class DocentCampus {
    ...
    public DocentCampus(Docent docent) {
		this.id = docent.getId();
		this.voornaam = docent.getVoornaam();
		this.familienaam = docent.getFamilienaam();
		this.campusnaam = docent.getCampussen().getNaam();
	}
